...
class Hooks {
	 ...
	 * @param callback $function_to_add The name of the function to be called when 
	 ...
	 * 
	 * @return mixed If $function_to_check is omitted, returns boolean for whether the hook 
	 * 	has anything registered. When checking a specific function, the priority of that 
	 *	hook is returned, or false if the function is not attached. When using the 
	 *	$function_to_check argument, this function may return a non-boolean value that 
	...
	/**
	 * apply_filters_ref_array Execute functions hooked on a specific filter hook, specifying arguments 
	 * in an array.
	 * 
	 * @access public
	 * @since 0.1
